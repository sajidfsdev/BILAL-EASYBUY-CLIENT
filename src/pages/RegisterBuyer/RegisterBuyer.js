...
import Cities from "./../Register/cities";
...
import useStyles from "./RegisterBuyer.styles";

//redux ...
import { useSelector, useDispatch } from "react-redux";
import * as Actions from "./../../Store/Action/RegisterBuyer";
import * as ReduxTypes from "./../../Store/Constants/RegisterBuyer";
...
const Register = props => {
  ...
  //redux state...
  const showRegister_RP = useSelector(
    state => state.registerBuyer.showRegister
  );
  const buffer_RP = useSelector(state => state.registerBuyer.buffer);
  const errorMessage_RP = useSelector(
    state => state.registerBuyer.errorMessage
  );
  const isError_RP = useSelector(state => state.registerBuyer.isError);
  const registered_RP = useSelector(state => state.registerBuyer.registered);
  ...
  const handleFormSubmission = event => {
    ...
    const Buyer = {};
    Buyer.name = state.name;
    Buyer.email = state.email;
    Buyer.city = state.city;
    Buyer.contact = state.contact;
    Buyer.password = state.password;

    dispatch_RP(Actions.handleRegistration(Buyer));
  };
