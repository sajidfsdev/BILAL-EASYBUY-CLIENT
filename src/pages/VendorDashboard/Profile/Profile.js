...
import * as Action from "./../../../Store/Action/vendorProfile";
...
const Profile = (props) => {
  ...
  const profile_RP = useSelector((state) => state.vendorProfile.profile);
  const loaded_RP = useSelector((state) => state.vendorProfile.loaded);
  const isError_RP = useSelector((state) => state.vendorProfile.isError);
  const errorMessage_RP = useSelector(
    (state) => state.vendorProfile.errorMessage
  );
  ...
  useEffect(() => {
    console.log("Please check the loaded Vendor profile info*****");
    console.log("******************************************");
    console.log("*******************************************");
