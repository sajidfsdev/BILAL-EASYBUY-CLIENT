...
const StepOne = (props) => {
  ...
  const [catFieldValue, setCatFieldValue] = useState(props.state.cat);
  const [subCatFieldValue, setSubCatFieldValue] = useState(props.state.subCat);
  const [subSubCatFieldValue, setSubSubCatFieldValue] = useState(
      ...
      <Row className={classes.container}>
        <Row className={classes.leftArea}>
          <Autocomplete
            ...
            inputValue={subSubCatFieldValue}
            onChange={(event, value) => {
